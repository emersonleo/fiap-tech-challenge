package br.com.fiap.tech.challenge.grupo.vinte.oito.chefonline.controllers.swagger;

import br.com.fiap.tech.challenge.grupo.vinte.oito.chefonline.controllers.handlers.ErrorResponse;
...
public interface ProprietarioControllerSwagger {
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
            ...
            content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = ProprietarioRequestDTO.class),
                    examples = @io.swagger.v3.oas.annotations.media.ExampleObject(
    ...
    @PostMapping
    ResponseEntity<Void> criaProprietario(@RequestBody ProprietarioRequestDTO proprietarioRequestDTO);
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Lista de proprietários retornada com sucesso", content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = ProprietarioResponseDTO.class),
                    examples = @io.swagger.v3.oas.annotations.media.ExampleObject(
    ...
    @GetMapping
    ResponseEntity<List<ProprietarioResponseDTO>> buscaTodosProprietarios(@RequestParam int page, @RequestParam int size);
    ...
    @GetMapping("/{id}")
    ResponseEntity<ProprietarioResponseDTO> buscaProprietarioPorId(@PathVariable Long id);
    ...
    @PutMapping("/{id}")
    ResponseEntity<Void> atualizaProprietario(@RequestBody ProprietarioRequestDTO proprietarioRequestDTO, @PathVariable Long id);
